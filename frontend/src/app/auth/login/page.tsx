  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-brand-700/5 rounded-full blur-3xl" />
      </div>
      ...
      >
        <div className="glass rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm">Entre para acessar sua conta</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="#" className="text-xs text-brand-400 hover:text-brand-300">Esqueceu?</Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Não tem conta?{' '}
            <Link href="/auth/register" className="text-brand-400 hover:text-brand-300 font-medium">Cadastre-se</Link>
          </p>
        </div>
      </motion.div>
    </div>
