        ...
        <div className="glass rounded-2xl p-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <p className="text-xs text-muted-foreground">
              ...
              <Link href="#" className="text-brand-400 hover:underline">Termos de Uso</Link> e{' '}
              <Link href="#" className="text-brand-400 hover:underline">Política de Privacidade</Link>.
